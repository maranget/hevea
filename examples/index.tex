...
\begin{tocenv}
\item The on-line
\ahref{http://www.enseignement.polytechnique.fr/profs/informatique/Luc.Maranget/compil/poly/}{``\emph{polycopié}''}
of my compilation course at École polytechnique.
\item Another on-line
\ahref{http://www.enseignement.polytechnique.fr/informatique/IF/poly/index.html}{``\emph{polycopié}''}
from École polytechnique.
\item \ahref{http://www.grappa.univ-lille3.fr/polys/reseaux-2004/index.html}{Another course}, from Université de Lille~III.
\end{tocenv}
\item Manuals and tutorials.
\begin{tocenv}
\item The on-line manual of \ahref{\url|http://www.lri.fr/~pouzet/lucid-synchrone/manual_html/index.html|}{Lucid Synchrone}.
\item The on-line
\ahref{http://caml.inria.fr/pub/docs/manual-ocaml/index.html}{Objective Caml}.
\item The on-line
