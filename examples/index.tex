...
\begin{itemize}
\item The on-line
\ahref{http://www.enseignement.polytechnique.fr/profs/informatique/Luc.Maranget/compil/poly/}{``\emph{polycopiés}''}
of my compilation course at École polytechnique.
\item Another on-line
\ahref{http://www.enseignement.polytechnique.fr/informatique/IF/poly/index.html}{``\emph{polycopiés}''}
from École polytechnique.
\item The on-line
\ahref{http://caml.inria.fr/pub/docs/manual-ocaml/index.html}{Objective Caml manual}.
\item The on-line
