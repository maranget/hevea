\documentstyle[../html,fullpage,isolatin1]{article}

\def\homedir{http://www.polytechnique.fr/poly/edu/profs/Luc.Maranget}
\begin{latexonly}
\gdef\url#1#2{#2}
\end{latexonly}
\def\oneurl#1{\url{#1}{{\tt #1}}}
...
La solution de cet exercice apparaîtra \url{hp.txt}{en hp.txt}.
