...
\subsection{Espaces et commandes}
\let\boite=\textbf
Avec espace ``\boite{avant} après''.

\let\decl=\bf
Sans espace  ``{avant\bf après}'', ``{avant\decl après}''.

\newcommand{\avant}{avant}
Sans espace ``\avant après''


{\let\monverb\verb \monverb+coucou+}
\monverb{Erreur}.
