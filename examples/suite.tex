...
\begin{center}
\ifhevea\renewcommand{\@table@attributes}{style="width:50\%;border:ridge 10px"}\fi
\begin{tabular}{cc}
coucou & foo \\
argl   & bar
\end{tabular}
...
Une note recomposée\footnotemark\footnotetext{Numéro \ifhevea{}quatre\else{}trois\fi}.
...
pas est à considérer là où il apparaissent en tant qu'arguments.
