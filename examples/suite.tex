...
\newenvironment{damier}[1]
  {\ifhevea\renewcommand{\@table@attributes}{CELLSPACING=0 CELLPADDING=4 BORDER=0}\fi
...
\end{list}
Avec les références \ref{zob:triv}, \ref{zob:under}
et~\ref{zob:compare}.
...
Et puis aussi la façon de procéder, c'est à dire en mode
\empg{display} dès le début~:
$$
\left[\begin{array}{c}
