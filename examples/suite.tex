\documentstyle[html,isolatin1]{article}

\title{Test de \htmlgen\footnote{Une étoile}}
...
Alors j'y vais~: $1+a_{i+1} + \int^N_0 1/x dx + \partial x/2$
...
\newtheorem{ath}[th]{Autre théorème}
