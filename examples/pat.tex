\documentstyle[fullpageusa,isolatin1,html]{article}

\addtolength{\topmargin}{-1cm}
\input{pat.def}


\def\showgraph{\par\medskip\centerline{%% BEGIN IMAGE
\box\graph
%%END IMAGE
}\medskip}
\def\status#1{{\tt #1}}
...
\begin{array}{rl@{~}c@{~}rl@{\quad}l}
  &\tth P_1 | P_2   &\redstruct&           &\tth P_1, P_2 &\hbox{S-Par}\\
D_1 \And D_2 &\tth             &\redstruct& D_ 1, D_2 &\tth   &\hbox{S-And}\\
