...
on whether \LaTeX{} has been run previously or not:
\begin{itemize}
...
this file having been created by a previous run
of \hevea. Thus, in that case, \hevea{} must run twice to get
cross-references right.
Just like \LaTeX,
\hevea{} issues a warning then the cross-referencing information it
generates differs from what it has read at start-up.
\end{itemize}

Note that if a non-correct \filename{mydoc}\texttt{.aux} file is
