...
Additionnaly, a few boolean registers are defined by \hevea{}.
...
\subsection{The \texttt{array} and \texttt{tabularx} Packages}
...
Ancilary files (such as the \texttt{.aux} file)
will be searched as \textit{basein}\verb+.+\textit{ext}.
The output of \hevea{} normally goes to the file \textit{basout}\texttt{.html}.
