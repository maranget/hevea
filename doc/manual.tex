...
\verb+HTML+ and \verb+BODY+ opening tags (cf. \verb+\@bodyargs+,
\verb+\@htmlargs+), and the arguments to the
...
provided their \textit{level} is greater then or equal to the current
