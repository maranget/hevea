...
\texttt{cmyk} and \texttt{named} color models.
...
\begin{verbatim}
\begin{bgcolor}[CELLPADDING=0 ALIGN=center]{yellow}
\color{\red}Red letters on a yellow backgroud
\end{bgcolor}
\end{verbatim}

will be typeset on a yellow background, in the center of the page,
and with no padding.
\begin{htmlonly}
\begin{bgcolor}[CELLPADDING=0 ALIGN=center]{yellow}
\color{red}Red letters on a yellow backgroud
\end{bgcolor}
\end{htmlonly}
Users are warned that browsers manage \verb+ALIGN+ attributes
to tables in a sometime hard to predict manner.
...
making a local copy of the \texttt{fancysection.hva} file and by
editing the color section in this copy.
