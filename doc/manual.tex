...
\verb+htmlgen article.sty -e acmconf.sty acmarticle.sty+ that instruct
\htmlgen\ first to load its \verb+article.sty+ style file and then not to
attempt to load \verb+acmconf.sty+.
...
Consider another example, \urlex{trouble.tex}
