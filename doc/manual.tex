...
\hevea{} provides a hopefully correct implementation of this package.
...
\verb+\month+, \verb+\day+ and \verb+\time+ are defined and
...
Counter \texttt{Hour} & hour, 0\ldots{}11\\
Counter \texttt{weekday} & day of week, 0\ldots{}6\\
Counter \texttt{minute}  & minute, 0\ldots{}59\\
Counter \texttt{second}  & second, 0\ldots{}59\\ \hline
Command \verb+\ampm+ & AM or PM\\
Command \verb+\timezone+ & Time zone\\
