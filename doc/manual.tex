...
\newcommand{\base}{ftp://ftp.inria.fr/INRIA/Projects/para/hevea}%
This manual also exist in
\url{\base/hevea-\heveaversion-manual.ps.gz}{Postcript} and and as
a \url{\base/hevea-\heveaversion-manual.tar.gz}{bundle of HTML files}.
\@print{
<HR>
}%
\end{htmlonly}
...
the same macros).
More generally, most  base styles which are neither
...
script, which basically calls, \LaTeX, ghostscript and a few tools from
...
The details are given in the \texttt{README} file in the distribution.
