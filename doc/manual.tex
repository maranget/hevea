...
processor, file loading, the \texttt{html.sty} style
file and comments.
...
section~\ref{hacha})
are defined as null macros in the \texttt{html.sty} file.
...
Browsers may fail to display non-ascii characters in at least two
manners.
\begin{itemize}
\item The first and more frequent case regards characters from the symbol
fonts.
\end{itemize}
...
\item[{\tt -noiso}] Avoid (iso-latin1) chararacters whose code is above 127.
These characters are replaced by \html{} entities.
