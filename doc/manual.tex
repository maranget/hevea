...
the \texttt{display} and \textt{math} condition that are set according
...
a \textit{base}\textt{.image.tex} file.
...
page in the \textit{base}\textt{.image.tex} file,
...
The choice is made by checking wether \texttt{dvips} accepts the
