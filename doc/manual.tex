...
Additionally,
the \verb+\texdef+ and \verb+\texlet+ tokens (see
section~\ref{texmacro})
are defined as \verb+\def+ and \verb+\let+ in
in the \texttt{hevea.sty} file,
while
the \verb+\imageflush+ macro that controls included images
