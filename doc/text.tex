...
\subsection{Links for the root file}
...
\texttt{hevea png.hva\ldots} (so that the proper ``\texttt{.png}'' filename
extension is given to image file references from within the \html{} document).
