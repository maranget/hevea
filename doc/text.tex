...
The \verb+theindex+~environment is replaced by \verb+the@hevea@index+,
which places all index entries in class~\verb+theindex+.  The environment
can be modified with the usual magic:
...
\noindent For the common task of adding a prolog to the index the
\footahref{https://www.ctan.org/pkg/imakeidx}{imakeidx}-package
compatible macro \verb+\indexprologue+ is available.


The index entries themselves are formatted using special
