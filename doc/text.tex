...
\subsection{Targetting \label{winfonts}Windows Internet Explorer}
\index{display problems!for authors}%
At the time of this release, Internet Explorer support for symbols
through Unicode is not as complete as the one of Firefox, which I am
...
We (hopefully) expect Internet Explorer to  display more of
...
when viewed through Internet Explorer are thus advised to
