...
\index{style-sheets!divstyle (environment)@divstyle}\envdefindex{divstyle}
...
\subsubsection{List styling with environment~\texttt{itemize}}\index{styles for!lists}
\newcounter{toc}
\newenvironment{toc}
...
\item[{\tt -moreentities}] Enable the output of some rare entities. Use
