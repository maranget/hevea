...
It is also the perfect place to activate (or deactivate)
OpenType~features exactly for one specific family
...
\paragraph{\textsc{OpenType} Feature: \verb+smcp+.}
...
\footahref{https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Fonts/OpenType_fonts_guide}{\textsc{OpenType}~fonts
  guide} and help on
...
\footahref{https://www.w3schools.com/cssref/css_units.asp}{CSS units}.
...
\footahref{https://www.w3schools.com/css/css3_variables.asp}{CSS~variables}
