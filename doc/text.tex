...
\ttindex{mathjax}{package}\envdefindex{dsiplayjax}\comdefindex{textjax}

\ahref{https://www.mathjax.org/}{MathJax} support is enabled by loading the
\textsf{mathjax} package. That is, \verb+\usepackage{mathjax}+ appears in document preamble, or \hevea{} is invoked as \verb+hevea mathjax.hva+\ldots
Basic support consists in one environment
\texttt{displayjax} and one command~\verb+\textjax+.
