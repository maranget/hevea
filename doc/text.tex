...
the \verb+theindex+~environment; \verb+the@hevea@index+
places all index entries in class~\verb+theindex+.  The environment
can be modified with the commonly accepted magic:
