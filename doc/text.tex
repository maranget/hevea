...
\begin{itemize}
  ...
  processing \verb+\begin{document}+). However there are two subtlities
...
four windows encodings, and the \texttt{applemac} encoding.
...
\item[{\tt -tocbis}]
Add a small table of contents at the beginning of
every file.
\item[{\tt -tocter}]
...
and \texttt{hevea} output file \texttt{doc.html}, which is not more useful once
\texttt{hacha} has run.
