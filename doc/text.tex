...
\item[\protect\texttt{.hbbl}] The \filename{mydoc}\texttt{.hbbl} file
is generated by \texttt{bibhva} from \filename{mydoc}\texttt{.haux}.
When present, it is read by the \verb+\bibliography+ command.

\item[\protect\texttt{.bbl}] The \filename{mydoc}\texttt{.bbl} file is
generated by \BibTeX{} from \filename{mydoc}\texttt{.aux}.
When present, and if no \filename{mydoc}\texttt{.hbbl} exists,
\filename{mydoc}\texttt{.bbl} is read by the \verb+\bibliography+ command.
